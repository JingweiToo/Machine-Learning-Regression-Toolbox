...
def jho(feat, label, opts):
    ...
    print("Mean Square Error (LASSO_HO):", mse)
    print("R Square Score (LASSO_HO):", r2)
    
    lasso = {'mse': mse, 'r2': r2, 'xtest': xtest, 'ytest': ytest, 'ypred': ypred}
...
def jkfold(feat, label, opts):
    ...
    print("Mean Square Error (LASSO_K-fold):", mse)
    print("R Square Score (LASSO_K-fold):", r2)
    
    lasso = {'mse': mse, 'r2': r2, 'xtest': xtest2, 'ytest': ytest2, 'ypred': ypred2}
...
def jloo(feat, label, opts):
    ...
    print("Mean Square Error (LASSO_LOO):", mse)
    print("R Square Score (LASSO_LOO):", r2)
