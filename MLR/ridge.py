...
def jho(feat, label, opts):
    ...
    print("Mean Square Error (RIDGE_HO):", mse)
    print("R Square Score (RIDGE_HO):", r2)
    
    ridge = {'mse': mse, 'r2': r2, 'xtest': xtest, 'ytest': ytest, 'ypred': ypred}
...
def jkfold(feat, label, opts):
    ...
    print("Mean Square Error (RIDGE_K-fold):", mse)
    print("R Square Score (RIDGE_K-fold):", r2)
    
    ridge = {'mse': mse, 'r2': r2, 'xtest': xtest2, 'ytest': ytest2, 'ypred': ypred2}
...
def jloo(feat, label, opts):
    ...
    print("Mean Square Error (RIDGE_LOO):", mse)
    print("R Square Score (RIDGE_LOO):", r2)
